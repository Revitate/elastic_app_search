...
abstract class $ElasticResultMetaCopyWith<$Res> {
  ...
  @useResult
  $Res call({double? score, String? engine});
}
...
class _$ElasticResultMetaImpl implements _ElasticResultMeta {
  _$ElasticResultMetaImpl({this.score, this.engine});
  ...
  @override
  String toString() {
    return 'ElasticResultMeta(score: $score, engine: $engine)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, score, engine);
...
abstract class _ElasticResultMeta implements ElasticResultMeta {
  factory _ElasticResultMeta({final double? score, final String? engine}) =
